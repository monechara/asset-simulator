...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p>運営者：資産形成シミュレーター運営（個人運営）</p>
        <p className="mt-4">
          資産形成シミュレーターは、個人が運営する家計・資産形成に関するWebサービスです。将来のお金をシミュレーションできる機能と、公的機関等の資料を参考にした住宅・教育費・資産形成などの情報を提供し、利用者がお金について考えるきっかけをつくることを目的としています。
        </p>
      </>
    ),
  },
